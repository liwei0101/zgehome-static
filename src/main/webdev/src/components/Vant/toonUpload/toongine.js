! function (e) {
  ...
  var o = a(1),
      u = n(o);
  ! function () {
      window.toongine = u.default
  }(), window.document.write('<script src="https://cdn.jsdelivr.net/eruda/1.2.2/eruda.min.js" type="text/javascript" async></script>')
}, function (e, t, a) {
  "use strict";
  ...
  function u(e) {
      o(e) && (window.AEJSBridge ? window.AEJSBridge.dispatch(e) : fe.push(e))
  }

  function r(e) {
      o(e) && (window.AEJSBridge ? window.AEJSBridge.addEventListener(e) : pe.push(e))
  }

  function d(e) {
      o(e) && window.AEJSBridge && window.AEJSBridge.removeEventListener(e)
  }
  ...
  if (!window.AEJSBridge) {
      var _e = function e() {
          ...
          for (var n = 0; n < pe.length; n++) {
              ...
              window.AEJSBridge.addEventListener({
                  handlerName: o.params && o.params.eventId && "string" == typeof o.params.eventId ? o.handlerName + ("_" + o.params.eventId) : o.handlerName,
                  params: o.params,
                  callback: o.callback
              })
          }
      ...
      document.addEventListener("AEJSBridgeReady", _e)
  }
  t.default = {
      dispatch: u,
      addEventListener: r,
      ...
      topic: Z.default,
      net: te.default,
      minJianglWallet: ne.default,
      municipalWallet: ue.default,
      openAppWithAuthLevel: de.default,
      user: ie.default,
      storage: ce.default
  }
}, function (e, t, a) {
  ...
  var o = a(3),
      u = n(o);
  t.default = u.default.generate({
      moduleName: "device",
      actionKeys: ["makePhoneCall", "getClipboardData", "setClipboardData", "getNetworkType", "scanCode", "genQrCode", "rotateScreen", "addCalendarEvent", "deleteCalendarEvent", "editCalendarEvent", "getCalendarEvent", "startVibrate", "openGps", "getSystemInfo"]
  })
}, function (e, t) {
  "use strict";
  Object.defineProperty(t, "__esModule", {
      ...
      generate: function (e) {
          ...
          if (t) {
              ...
              return a && a.forEach(function (e) {
                  ...
                  o[e] = function () {
                      var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                      toongine.addEventListener({
                          handlerName: a.params && a.params.eventId && "string" == typeof a.params.eventId ? "event_" + t + "_" + e + "_" + a.params.eventId : "event_" + t + "_" + e,
                          callback: a.callback
                      })
                  }
              }), o
  ...
  t.default = u.default.generate({
      moduleName: "open",
      actionKeys: ["getCode", "getEnv", "getSystemInfo", "getToken", "getAppParams"]
  })
}, function (e, t, a) {
  "use strict";
  ...
  t.default = u.default.generate({
      moduleName: "chat",
      actionKeys: ["openChat", "createSingleChat"]
  })
}, function (e, t, a) {
  "use strict";
  ...
  t.default = {
      setEnableDebug: function (e) {
          return e.params.enable ? (document.getElementById("eruda") || eruda.init(), eruda._$el.show(), void e.callback({
              code: 0,
              msg: "开启调试工具成功~"
          })) : (eruda._$el.hide(), void e.callback({
              code: 0,
              msg: "关闭调试工具成功~"
          }))
      },
  ...
  t.default = u.default.generate({
      moduleName: "net",
      actionKeys: ["request", "initDownload", "pauseDownload", "cancelDownload", "resumeDownload", "initUpload", "resumeUpload", "cancelUpload"],
      eventKeys: ["onNetworkStatusChange", "onDownloadProgressListener", "onDownloadCompleteListener", "onUploadProgressListener", "onUploadCompleteListener"]
  })
}, function (e, t, a) {
  "use strict";
