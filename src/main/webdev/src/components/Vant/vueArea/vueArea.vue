        ...
        <div class="ProvCityContent">
          <div class="ProvCityContentList">
            ...
            >
              ...
              <li></li>
              <li
                v-for="(item, index) in provinceState.data"
                :key="index"
                :class="{
          ...
          <div class="ProvCityContentList">
            ...
            >
              ...
              <li></li>
              <li
                v-for="(item, index) in cityState.data"
                :key="index"
                :class="{
          ...
          <div class="ProvCityContentList">
            ...
            >
              ...
              <li></li>
              <li
                v-for="(item, index) in areaState.data"
                :key="index"
                :class="{
...
<script>
import { province, city, area } from "./cityDate.js";
export default {
  name: "vueArea",
  data() {
    return {
  ...
  methods: {
    ...
    filterCity() {
      ...
      this.cityState.selectedId =
        this.cityState.data[0] && this.cityState.data[0].code;
    ...
    filterArea() {
      ...
      this.areaState.selectedId =
        this.areaState.data[0] && this.areaState.data[0].code;
